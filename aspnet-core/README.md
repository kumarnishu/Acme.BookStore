...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 599b7d87-2b57-488d-9452-0992fcb26dea
```

> `599b7d87-2b57-488d-9452-0992fcb26dea` is the password of the certificate, you can change it to any password you want.
